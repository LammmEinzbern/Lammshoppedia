...
const Footer = () => {
  return (
    <div>
      <footer class="w-full bg-gray-600 dark:bg-gray-700 py-16">
        <div class="md:px-12 lg:px-28">
          <div class="container m-auto space-y-6 text-white dark:text-gray-300">
            ...
            >
              ...
              <li role="listitem">
                <a href="/product" class="hover:text-primary">
                  Product
                </a>
              </li>
              <li role="listitem">
            ...
            <div class="m-auto flex w-max items-center justify-between space-x-4">
              <a href="tel:+6285824697925" aria-label="call">
                <svg
              ...
              <a href="mailto:meguminn759@mail.com" aria-label="send mail">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  class="m-auto w-5"
              ...
              <a
                href="https://www.linkedin.com/in/ilham-purnama-hadi-3666a7266/"
                title="linkedin"
                target="blank"
                aria-label="linkedin"
              >
            ...
            <div class="text-center">
              <span class="text-sm tracking-wide">
                Copyright © Lammdev <span id="year"></span> | All right reserved
              </span>
            </div>
          </div>
        </div>
